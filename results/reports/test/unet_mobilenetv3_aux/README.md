...
- `unet_mobilenetv3_aux`
  - checkpoint/source: `models\unet_mobilenetv3_aux_mobilenetv3_large_dil0_bilin1_pre1.pth.tar`
  - prediction directory: `results\predictions\test\unet_mobilenetv3_aux`

...
- `fcn32s_resnet50`
  - checkpoint/source: `models\fcn32s_resnet50_dil0_bilin1_pre1.pth.tar`
  - prediction directory: `results\predictions\test\fcn32s_resnet50`
